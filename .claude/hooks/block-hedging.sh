...
RULE2_PATTERN='\b(more likely|maybe|might|potentially|perhaps|presumably|likely|probably|almost certainly|almost always|fairly certain|could be|seems to|appears to|I think|I believe)\b|you may want to check|you should verify|I.?d recommend confirming|\bI (can.?t|cannot|can not) (verify|confirm|check|tell|determine|be sure)\b|\b(unable|not able) to (verify|confirm|check|tell|determine|be sure)\b|\bno way (to|for me to) (verify|confirm|check|tell|determine|be sure)\b|\bcannot be (verified|confirmed|checked|determined)\b'
